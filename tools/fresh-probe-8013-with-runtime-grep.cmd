...
echo ==== %date% %time% runtime dialog grep ==== >> "%LOG%"
docker compose exec -T ragflow-cpu grep -n "我还没有学会\|stream_prefix.strip\|_strip_transient_refusal_prefix\|正在检索资料" /ragflow/api/db/services/dialog_service.py >> "%LOG%" 2>&1
